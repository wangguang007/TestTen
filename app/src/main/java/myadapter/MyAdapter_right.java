...
public class MyAdapter_right extends RecyclerView.Adapter<MyAdapter_right.ViewHolder> {
    private Context context;

    private List<Bean_right.DatasBean.ClassListBean> list;
    ...
    public MyAdapter_right(Context context, List<Bean_right.DatasBean.ClassListBean> list) {
